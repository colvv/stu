				...
				<div class="form-group mg-t-10">
					...
					<div class="form-group ">
						...
						<div class="input-group  date form_date" data-date-format="yyyy-mm-dd" name="stu_birthday_div">
							<input class="form-control" name="stu_birthday" type="text" placeholder="请输入学生出生日期" validation="required|date" value="${stu_birthday }"> <span
								class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
						</div>
					</div>
					<div class="form-group ">
						<label class="control-label" for="stu_phone">联系方式</label> <input class="form-control" name="stu_phone" type="text"
							placeholder="请输入联系方式" validation="required|len=11" value="${stu_phone }">
					</div>
				</div>
