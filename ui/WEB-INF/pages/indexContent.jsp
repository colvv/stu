...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="row color-bg-w">
				...
				<div class="panel panel-primary">
					...
					<a href="#">
						<div class="panel-footer">
							<span class="pull-left text-primary">查看详情</span> <span class="pull-right"><i class="fa fa-send-o text-primary"></i></span>
			...
			<div class="col-xs-3">
				<div class="panel panel-default">
					...
					<a href="#">
						<div class="panel-footer">
							<span class="pull-left text-muted">查看详情</span> <span class="pull-right"><i class="fa fa-send-o text-muted"></i></span>
							<div class="clearfix"></div>
						</div>
					</a>
				</div>
			...
			<div class="col-xs-3">
				<div class="panel panel-success">
					...
					<a href="#">
						<div class="panel-footer">
							<span class="pull-left text-success">查看详情</span> <span class="pull-right"><i class="fa fa-send-o text-success"></i></span>
							<div class="clearfix"></div>
						</div>
					</a>
				</div>
			...
			<div class="col-xs-3">
				<div class="panel panel-warning">
					...
					<a href="#">
						<div class="panel-footer">
							<span class="pull-left text-warning">查看详情</span> <span class="pull-right"><i class="fa fa-send-o text-warning"></i></span>
							<div class="clearfix"></div>
						</div>
					</a>
				</div>
		...
		<div class="row">
			<div class="col-xs-10">
				<div class="panel panel-default">
					<div class="panel-heading">今日课程(2015年3月3日)</div>
					<!-- /.panel-heading -->
					<div class="panel-body">
						<table class="table">
							<thead>
