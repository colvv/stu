 ...
 *
 *
 * @modify by wangyi 20150409
 * changes will target by @wangyi
 */
...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "当前 _START_ 到 _END_ ,共有 _TOTAL_ 条",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(从 _MAX_ 条数据中进行过滤)",
	...
	DataTable.defaults.column = {
		 ...
		 *    } );
		 */
		// 2015-2-11 @wangyi : 更改空白选项，否则sql中都需要处理
		"sDefaultContent": '',
	...
	DataTable.models.oSettings = {
		 ...
		 *  @default null
		 */
		// 2015-2-12 @wangyi : 修改默认样式
		"sDom": "<<'pull-right'l><'pull-left'f><t>ip>",
